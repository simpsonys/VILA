...
```json
{
  ...
  "default_live_test_command":    "sdb -s $ip shell launch_app com.example.voice-app cmd_from_mockapp $utterance",
...
[03-28-2026 12:00:00.530] D/VOICE_CLIENT: MakeMetaDataParams server=mock-bixby-dev locale=ko-KR
...
├── Preset0_CmdMyBixby_pattern_config.json        # cmd_from_mockapp 트리거 기반 프리셋
├── Preset1_kAsr2Response_pattern_config.json     # ASR 응답 기반 프리셋
├── Preset2_CLACmdMyBixby_pattern_config.json     # CLA + ConvID/ReqID/CapsuleGoal 추출 프리셋
├── Preset3_MockTest_pattern_config.json          # Mock 테스트 전용 프리셋 ★
